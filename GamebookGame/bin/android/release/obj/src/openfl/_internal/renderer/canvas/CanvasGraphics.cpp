...
bool CanvasGraphics_obj::isCCW( Float x1,Float y1,Float x2,Float y2,Float x3,Float y3){
	HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","isCCW",0xce74af1d,"openfl._internal.renderer.canvas.CanvasGraphics.isCCW","openfl/_internal/renderer/canvas/CanvasGraphics.hx",478,0x0b9ff65e)
	HX_STACK_ARG(x1,"x1")
	HX_STACK_ARG(y1,"y1")
	HX_STACK_ARG(x2,"x2")
	HX_STACK_ARG(y2,"y2")
	...
	HX_STACK_ARG(skipT,"skipT")
{
		...
		HX_STACK_LINE(509)
		bool tmp4 = skipT;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(509)
		...
		if ((tmp5)){
			struct _Function_2_1{
				inline static Dynamic Block( ::openfl::_Vector::FloatVector &uvt,Float &max){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_internal/renderer/canvas/CanvasGraphics.hx",511,0x0b9ff65e)
					{
			...
			HX_STACK_LINE(511)
			Dynamic tmp6 = _Function_2_1::Block(uvt,max);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(511)
			return tmp6;
		}
		HX_STACK_LINE(515)
		...
		HX_STACK_LINE(515)
		{
			...
			HX_STACK_LINE(515)
			::openfl::_Vector::FloatVector tmp7 = ::openfl::_Vector::FloatVector_obj::__new(length,fixed,null());		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(515)
			::openfl::_Vector::FloatVector tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(515)
			tmp6 = tmp8;
		}
		HX_STACK_LINE(515)
		::openfl::_Vector::FloatVector result = tmp6;		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(517)
		{
			HX_STACK_LINE(517)
			int _g1 = (int)1;		HX_STACK_VAR(_g1,"_g1");
			...
			while((true)){
				...
				HX_STACK_LINE(517)
				int t = tmp10;		HX_STACK_VAR(t,"t");
				HX_STACK_LINE(519)
				bool tmp11 = skipT;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(519)
				bool tmp12;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(519)
				if ((tmp11)){
					HX_STACK_LINE(519)
					int tmp13 = hx::Mod(t,(int)3);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(519)
				...
				{
					HX_STACK_LINE(525)
					int tmp13 = (t - (int)1);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(525)
					Float tmp14 = uvt->get(tmp13);		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(525)
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::openfl::_Vector::FloatVector &result,Float &max){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/_internal/renderer/canvas/CanvasGraphics.hx",529,0x0b9ff65e)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("max","\xa4","\x0a","\x53","\x00") , max,false);
		...
		HX_STACK_LINE(529)
		Dynamic tmp7 = _Function_1_1::Block(result,max);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(529)
		return tmp7;
	}
}
...
{
		HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","renderMask",0xfa8ef652,"openfl._internal.renderer.canvas.CanvasGraphics.renderMask","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1247,0x0b9ff65e)
		HX_STACK_ARG(graphics,"graphics")
		HX_STACK_ARG(renderSession,"renderSession")
	}
return null();
...
{
		HX_STACK_FRAME("openfl._internal.renderer.canvas.CanvasGraphics","setSmoothing",0x84b8ec62,"openfl._internal.renderer.canvas.CanvasGraphics.setSmoothing","openfl/_internal/renderer/canvas/CanvasGraphics.hx",1354,0x0b9ff65e)
		HX_STACK_ARG(smooth,"smooth")
	}
return null();
}
