	...
	if ((tmp1)){
		...
		::String systemFontDirectory = tmp8;
		{
			...
			if (  ( _switch_2==HX_HCSTRING("_sans","\x32","\xa0","\x5e","\xff"))){
				::String tmp10 = (systemFontDirectory + HX_HCSTRING("/DroidSans.ttf","\xf8","\xc6","\x8e","\x4f"));
				...
				::String tmp10 = (systemFontDirectory + HX_HCSTRING("/DroidSansMono.ttf","\xbb","\x6c","\x31","\x55"));
				fontList = Array_obj< ::String >::__new().Add(tmp10);
			}
			else  {
...
;
	...
	::String tmp3 = (systemFontDirectory + HX_HCSTRING("/DroidSerif-Regular.ttf","\x57","\xb0","\xef","\x46"));
	::String tmp4 = (systemFontDirectory + HX_HCSTRING("/NotoSerif-Regular.ttf","\x59","\x73","\xf1","\x28"));
	fontList = Array_obj< ::String >::__new().Add(tmp3).Add(tmp4);
	{
		int _g = (int)0;
		while((true)){
			bool tmp5 = (_g < fontList->length);
			bool tmp6 = !(tmp5);
			if ((tmp6)){
				break;
			}
			::String tmp7 = fontList->__get(_g);
			::String font = tmp7;
			++(_g);
			::String tmp8 = font;
			::openfl::text::Font tmp9 = ::openfl::_internal::text::TextEngine_obj::findFont(tmp8);
			instance = tmp9;
			bool tmp10 = (instance != null());
			if ((tmp10)){
				::haxe::ds::StringMap tmp11 = ::openfl::_internal::text::TextEngine_obj::__defaultFonts;
				::String tmp12 = format->font;
				::openfl::text::Font tmp13 = instance;
				tmp11->set(tmp12,tmp13);
				::openfl::text::Font tmp14 = instance;
				return tmp14;
			}
		}
	}
