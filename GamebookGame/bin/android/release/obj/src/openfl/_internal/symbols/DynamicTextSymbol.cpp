...
{  hx::ObjectPtr< DynamicTextSymbol_obj > _result_ = new DynamicTextSymbol_obj();
...
::openfl::display::DisplayObject DynamicTextSymbol_obj::__createObject( ::openfl::_internal::swf::SWFLite swf){
	::openfl::text::TextField tmp = ::openfl::text::TextField_obj::__new();
	::openfl::text::TextField textField = tmp;
	::openfl::_internal::swf::SWFLite tmp1 = swf;
	textField->__fromSymbol(tmp1,hx::ObjectPtr<OBJ_>(this));
	::openfl::text::TextField tmp2 = textField;
	return tmp2;
}
...
Dynamic DynamicTextSymbol_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic DynamicTextSymbol_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
