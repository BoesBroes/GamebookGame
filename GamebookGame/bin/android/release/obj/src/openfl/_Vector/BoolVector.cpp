...
::openfl::_Vector::IVector BoolVector_obj::concat( ::openfl::_Vector::IVector a){
	bool tmp = (a == null());
	if ((tmp)){
		::openfl::_Vector::BoolVector tmp1 = ::openfl::_Vector::BoolVector_obj::__new(null(),null(),this->__array->copy());
		return tmp1;
	}
	else{
		::openfl::_Vector::BoolVector tmp1;
		tmp1 = hx::TCast< ::openfl::_Vector::BoolVector >::cast(a);
		::openfl::_Vector::BoolVector tmp2 = ::openfl::_Vector::BoolVector_obj::__new(null(),null(),this->__array->concat(tmp1->__array));
		return tmp2;
	}
	return null();
}
...
::openfl::_Vector::IVector BoolVector_obj::copy( ){
	bool tmp = this->fixed;
	::openfl::_Vector::BoolVector tmp1 = ::openfl::_Vector::BoolVector_obj::__new(null(),tmp,this->__array->copy());
	return tmp1;
}
...
bool BoolVector_obj::get( int index){
	int tmp = index;
	int tmp1 = this->__array->length;
	bool tmp2 = (tmp >= tmp1);
	if ((tmp2)){
		return false;
	}
	else{
		bool tmp3 = this->__array->__get(index);
		return tmp3;
	}
	return false;
}
...
{
		{
			...
			while((true)){
				...
				int tmp3 = (_g1)++;
				int i = tmp3;
				bool tmp4 = this->__array->__get(i);
				bool tmp5 = x;
				bool tmp6 = (tmp4 == tmp5);
				if ((tmp6)){
					int tmp7 = i;
...
::openfl::_Vector::IVector BoolVector_obj::reverse( ){
...
bool BoolVector_obj::set( int index,bool value){
	...
	if ((tmp4)){
		bool tmp5 = value;
		bool tmp6 = this->__array[index] = tmp5;
		return tmp6;
	}
	else{
		bool tmp5 = value;
...
Dynamic endIndex = __o_endIndex.Default(16777215);
{
		...
		::openfl::_Vector::BoolVector tmp2 = ::openfl::_Vector::BoolVector_obj::__new(null(),null(),this->__array->slice(tmp,tmp1));
		return tmp2;
	}
}
...
::openfl::_Vector::IVector BoolVector_obj::splice( int pos,int len){
	int tmp = pos;
	int tmp1 = len;
	::openfl::_Vector::BoolVector tmp2 = ::openfl::_Vector::BoolVector_obj::__new(null(),null(),this->__array->splice(tmp,tmp1));
	return tmp2;
}
