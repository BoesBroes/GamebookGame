...
Void GraphicsStroke_obj::__construct(Dynamic thickness,hx::Null< bool >  __o_pixelHinting,Dynamic __o_scaleMode,Dynamic __o_caps,Dynamic __o_joints,hx::Null< Float >  __o_miterLimit,::openfl::display::IGraphicsFill fill)
{
...
HX_STACK_ARG(__o_scaleMode,"scaleMode")
HX_STACK_ARG(__o_caps,"caps")
HX_STACK_ARG(__o_joints,"joints")
...
Float miterLimit = __o_miterLimit.Default(3);
{
	...
	if ((tmp)){
		HX_STACK_LINE(23)
		Float tmp1 = ::Math_obj::NaN;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(23)
		thickness = tmp1;
	}
	HX_STACK_LINE(25)
...
hx::ObjectPtr< GraphicsStroke_obj > GraphicsStroke_obj::__new(Dynamic thickness,hx::Null< bool >  __o_pixelHinting,Dynamic __o_scaleMode,Dynamic __o_caps,Dynamic __o_joints,hx::Null< Float >  __o_miterLimit,::openfl::display::IGraphicsFill fill)
{  hx::ObjectPtr< GraphicsStroke_obj > _result_ = new GraphicsStroke_obj();
	_result_->__construct(thickness,__o_pixelHinting,__o_scaleMode,__o_caps,__o_joints,__o_miterLimit,fill);
	return _result_;}
