...
{
HX_STACK_FRAME("openfl.display.ShaderParameter_Bool","new",0xb2db75c1,"openfl.display.ShaderParameter_Bool.new","openfl/display/ShaderParameter.hx",23,0xc89f13e6)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
	this->index = (int)0;
