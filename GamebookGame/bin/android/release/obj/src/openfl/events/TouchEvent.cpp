...
bool isTouchPointCanceled = __o_isTouchPointCanceled.Default(false);
{
	...
	this->stageX = tmp3;
	HX_STACK_LINE(58)
	Float tmp4 = ::Math_obj::NaN;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(58)
	this->stageY = tmp4;
}
;
...
::openfl::events::Event TouchEvent_obj::clone( ){
	...
	HX_STACK_LINE(66)
	::openfl::events::IEventDispatcher tmp17 = this->target;		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(66)
	event->target = tmp17;
	HX_STACK_LINE(67)
	::openfl::events::IEventDispatcher tmp18 = this->currentTarget;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(67)
...
::String TouchEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",74,0x2fe85d0c)
	HX_STACK_THIS(this)
	HX_STACK_LINE(76)
