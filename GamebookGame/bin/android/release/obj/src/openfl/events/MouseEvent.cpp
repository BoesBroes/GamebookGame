...
::openfl::events::Event MouseEvent_obj::clone( ){
	...
	HX_STACK_LINE(99)
	::openfl::events::IEventDispatcher tmp14 = this->target;		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(99)
	event->target = tmp14;
	HX_STACK_LINE(100)
	::openfl::events::IEventDispatcher tmp15 = this->currentTarget;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(100)
