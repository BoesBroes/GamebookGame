...
HX_STACK_ARG(soundTransform,"soundTransform")
{
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(45)
		::lime::media::AudioSource tmp2 = this->__source;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(45)
		...
		this->__isValid = true;
		HX_STACK_LINE(48)
		::lime::media::AudioSource tmp4 = this->__source;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(48)
		tmp4->play();
	}
	HX_STACK_LINE(52)
...
{
		HX_STACK_FRAME("openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",80,0xa4290000)
		HX_STACK_THIS(this)
		HX_STACK_LINE(82)
...
Float SoundChannel_obj::set_position( Float value){
	...
	HX_STACK_LINE(107)
	::lime::media::AudioSource tmp5 = this->__source;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(107)
...
::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	HX_STACK_FRAME("openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",113,0xa4290000)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
...
::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
	...
	if ((tmp)){
		...
		if ((tmp15)){
			HX_STACK_LINE(136)
			::lime::media::AudioSource tmp16 = this->__source;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(136)
			Float tmp17 = volume;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(136)
			tmp16->set_gain(tmp17);
			HX_STACK_LINE(138)
			::lime::media::AudioSource tmp18 = this->__source;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(138)
			...
			position->z = tmp25;
			HX_STACK_LINE(141)
			::lime::media::AudioSource tmp26 = this->__source;		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(141)
...
Dynamic SoundChannel_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__source") ) { __source=inValue.Cast< ::lime::media::AudioSource >(); return inValue; }
		break;
	case 9:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::media::AudioSource*/ ,(int)offsetof(SoundChannel_obj,__source),HX_HCSTRING("__source","\xfb","\x1b","\x61","\xda")},
	{ hx::fsUnknown, 0, null()}
};
