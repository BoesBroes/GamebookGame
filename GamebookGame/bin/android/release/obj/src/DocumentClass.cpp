...
{
HX_STACK_FRAME("DocumentClass","new",0x4aeb0a6f,"DocumentClass.new","ApplicationMain.hx",287,0x0780ded5)
HX_STACK_THIS(this)
HX_STACK_ARG(current,"current")
{
	HX_STACK_LINE(289)
	current->addChild(hx::ObjectPtr<OBJ_>(this));
	HX_STACK_LINE(290)
	super::__construct();
	HX_STACK_LINE(291)
	::openfl::events::Event tmp = ::openfl::events::Event_obj::__new(HX_HCSTRING("addedToStage","\x63","\x22","\x55","\x0c"),false,false);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(291)
