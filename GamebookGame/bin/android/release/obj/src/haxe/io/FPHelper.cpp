...
Float FPHelper_obj::i32ToFloat( int i){
	HX_STACK_FRAME("haxe.io.FPHelper","i32ToFloat",0x7999b6cf,"haxe.io.FPHelper.i32ToFloat","haxe/io/FPHelper.hx",62,0x803d7f86)
	HX_STACK_ARG(i,"i")
	HX_STACK_LINE(77)
...
int FPHelper_obj::floatToI32( Float f){
	HX_STACK_FRAME("haxe.io.FPHelper","floatToI32",0xff5a7c67,"haxe.io.FPHelper.floatToI32","haxe/io/FPHelper.hx",109,0x803d7f86)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(118)
...
Float FPHelper_obj::i64ToDouble( int low,int high){
	HX_STACK_FRAME("haxe.io.FPHelper","i64ToDouble",0xc51d801d,"haxe.io.FPHelper.i64ToDouble","haxe/io/FPHelper.hx",153,0x803d7f86)
...
cpp::Int64Struct FPHelper_obj::doubleToI64( Float v){
	HX_STACK_FRAME("haxe.io.FPHelper","doubleToI64",0xe6926a85,"haxe.io.FPHelper.doubleToI64","haxe/io/FPHelper.hx",219,0x803d7f86)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(246)
