...
{
HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","new",0xe4010c79,"lime.app.Promise_lime_graphics_Image.new","lime/app/Promise.hx",21,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
bool Promise_lime_graphics_Image_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isComplete",0xcb429393,"lime.app.Promise_lime_graphics_Image.get_isComplete","lime/app/Promise.hx",120,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(122)
...
bool Promise_lime_graphics_Image_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isError",0x9c864cae,"lime.app.Promise_lime_graphics_Image.get_isError","lime/app/Promise.hx",127,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(129)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(129)
