...
{
HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","new",0x68417acd,"lime.app.Promise_openfl_display_BitmapData.new","lime/app/Promise.hx",21,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
{  hx::ObjectPtr< Promise_openfl_display_BitmapData_obj > _result_ = new Promise_openfl_display_BitmapData_obj();
		...
		if ((tmp6)){
			HX_STACK_LINE(37)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(39)
					::openfl::display::BitmapData tmp11 = data;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(39)
...
bool Promise_openfl_display_BitmapData_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isComplete",0x02ecddbf,"lime.app.Promise_openfl_display_BitmapData.get_isComplete","lime/app/Promise.hx",120,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(122)
...
bool Promise_openfl_display_BitmapData_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_openfl_display_BitmapData","get_isError",0x531b2f02,"lime.app.Promise_openfl_display_BitmapData.get_isError","lime/app/Promise.hx",127,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(129)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(129)
...
Dynamic Promise_openfl_display_BitmapData_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_openfl_display_BitmapData_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
