...
{
HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","new",0x0f34710b,"lime.app.Promise_lime_utils_AssetLibrary.new","lime/app/Promise.hx",21,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
{  hx::ObjectPtr< Promise_lime_utils_AssetLibrary_obj > _result_ = new Promise_lime_utils_AssetLibrary_obj();
		...
		if ((tmp6)){
			HX_STACK_LINE(37)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(39)
					::lime::utils::AssetLibrary tmp11 = data;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(39)
...
bool Promise_lime_utils_AssetLibrary_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","get_isComplete",0x9cee3441,"lime.app.Promise_lime_utils_AssetLibrary.get_isComplete","lime/app/Promise.hx",120,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(122)
...
bool Promise_lime_utils_AssetLibrary_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_utils_AssetLibrary","get_isError",0x4d6b9340,"lime.app.Promise_lime_utils_AssetLibrary.get_isError","lime/app/Promise.hx",127,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(129)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(129)
...
Dynamic Promise_lime_utils_AssetLibrary_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_lime_utils_AssetLibrary_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
