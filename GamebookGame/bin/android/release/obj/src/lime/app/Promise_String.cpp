...
{
HX_STACK_FRAME("lime.app.Promise_String","new",0xecf99bcd,"lime.app.Promise_String.new","lime/app/Promise.hx",21,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
bool Promise_String_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_String","get_isComplete",0x76565cbf,"lime.app.Promise_String.get_isComplete","lime/app/Promise.hx",120,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(122)
...
bool Promise_String_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_String","get_isError",0x6e5c5002,"lime.app.Promise_String.get_isError","lime/app/Promise.hx",127,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(129)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(129)
