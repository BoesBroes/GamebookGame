...
{
HX_STACK_FRAME("lime.app.Promise_lime_text_Font","new",0x708368f3,"lime.app.Promise_lime_text_Font.new","lime/app/Promise.hx",21,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(23)
...
bool Promise_lime_text_Font_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isComplete",0x8a9ff559,"lime.app.Promise_lime_text_Font.get_isComplete","lime/app/Promise.hx",120,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(122)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(122)
...
bool Promise_lime_text_Font_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isError",0xc3d0b328,"lime.app.Promise_lime_text_Font.get_isError","lime/app/Promise.hx",127,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(129)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(129)
