...
Void System_obj::exit( int code){
{
		bool tmp = (code == (int)0);
		if ((tmp)){
			::lime::_system::JNIStaticField tmp1 = ::lime::_system::JNI_obj::createStaticField(HX_HCSTRING("org/haxe/extension/Extension","\xb1","\xf4","\x56","\x51"),HX_HCSTRING("mainActivity","\x28","\x83","\x72","\x14"),HX_HCSTRING("Landroid/app/Activity;","\x52","\xcb","\x53","\x45"));
			::lime::_system::JNIStaticField mainActivity = tmp1;
			Dynamic tmp2 = ::lime::_system::JNI_obj::createMemberMethod(HX_HCSTRING("android/app/Activity","\x7d","\xf6","\xa1","\xaf"),HX_HCSTRING("moveTaskToBack","\xd8","\x80","\xa8","\x0c"),HX_HCSTRING("(Z)Z","\xc3","\xf7","\xb4","\x1a"),null(),null());
			Dynamic moveTaskToBack = tmp2;
			Dynamic tmp3 = mainActivity->__Field(HX_HCSTRING("get","\x96","\x80","\x4e","\x00"), hx::paccDynamic )();
		...
		if ((tmp2)){
			...
			bool tmp6 = tmp5->onExit->canceled;
			if ((tmp6)){
				return null();
			}
		}
...
::lime::_system::Display System_obj::getDisplay( int id){
	...
	if ((tmp)){
		...
		Dynamic tmp3 = ::lime::_system::JNI_obj::createStaticMethod(HX_HCSTRING("org/haxe/lime/GameActivity","\x1d","\x61","\xc7","\xa4"),HX_HCSTRING("getDisplayDPI","\x71","\x66","\x32","\x3a"),HX_HCSTRING("()D","\x23","\x7e","\x1e","\x00"),null(),null());
		Dynamic getDisplayDPI = tmp3;
		Float tmp4 = getDisplayDPI().Cast< Float >();
		int tmp5 = ::Math_obj::round(tmp4);
		display->__FieldRef(HX_HCSTRING("dpi","\x5d","\x43","\x4c","\x00")) = tmp5;
		...
		::lime::_system::DisplayMode displayMode;
		{
			...
			while((true)){
				bool tmp6 = (_g < _g1->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));
				bool tmp7 = !(tmp6);
				if ((tmp7)){
					break;
				}
				Dynamic tmp8 = _g1->__GetItem(_g);
				Dynamic mode = tmp8;
				++(_g);
				::lime::_system::DisplayMode tmp9 = ::lime::_system::DisplayMode_obj::__new(mode->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic ),mode->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic ),mode->__Field(HX_HCSTRING("refreshRate","\x5b","\xe2","\x3f","\x40"), hx::paccDynamic ),mode->__Field(HX_HCSTRING("pixelFormat","\x5d","\x72","\x1b","\x6f"), hx::paccDynamic ));
				displayMode = tmp9;
				::lime::_system::DisplayMode tmp10 = displayMode;
				display->__Field(HX_HCSTRING("supportedModes","\xa2","\xa6","\xb8","\xb7"), hx::paccDynamic )->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp10);
			}
		}
		...
		::lime::_system::DisplayMode currentMode = tmp6;
		{
			int _g = (int)0;
			Array< ::Dynamic > _g1 = display->__Field(HX_HCSTRING("supportedModes","\xa2","\xa6","\xb8","\xb7"), hx::paccDynamic );
			while((true)){
				bool tmp7 = (_g < _g1->length);
				bool tmp8 = !(tmp7);
				if ((tmp8)){
					break;
				}
				::lime::_system::DisplayMode tmp9 = _g1->__get(_g).StaticCast< ::lime::_system::DisplayMode >();
				::lime::_system::DisplayMode mode1 = tmp9;
				++(_g);
				bool tmp10 = (currentMode->__Field(HX_HCSTRING("pixelFormat","\x5d","\x72","\x1b","\x6f"), hx::paccDynamic ) == mode1->__Field(HX_HCSTRING("pixelFormat","\x5d","\x72","\x1b","\x6f"), hx::paccDynamic ));
				bool tmp11 = tmp10;
				bool tmp12;
				if ((tmp11)){
					tmp12 = (currentMode->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic ) == mode1->__Field(HX_HCSTRING("width","\x06","\xb6","\x62","\xca"), hx::paccDynamic ));
				}
				else{
					tmp12 = false;
				}
				...
				bool tmp14;
				if ((tmp13)){
					tmp14 = (currentMode->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic ) == mode1->__Field(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02"), hx::paccDynamic ));
				}
				else{
					tmp14 = false;
				}
				bool tmp15;
				if ((tmp14)){
					tmp15 = (currentMode->__Field(HX_HCSTRING("refreshRate","\x5b","\xe2","\x3f","\x40"), hx::paccDynamic ) == mode1->__Field(HX_HCSTRING("refreshRate","\x5b","\xe2","\x3f","\x40"), hx::paccDynamic ));
				}
				else{
					tmp15 = false;
				}
		...
		::lime::_system::Display tmp7 = display;
		return tmp7;
	}
	return null();
}
...
Void System_obj::openFile( ::String path){
{
		bool tmp = (path != null());
		if ((tmp)){
			Dynamic tmp1 = ::lime::_system::JNI_obj::createStaticMethod(HX_HCSTRING("org/haxe/lime/GameActivity","\x1d","\x61","\xc7","\xa4"),HX_HCSTRING("openFile","\x66","\xab","\xf7","\xe4"),HX_HCSTRING("(Ljava/lang/String;)V","\x7f","\xb4","\xbc","\xc7"),null(),null());
			Dynamic openFile = tmp1;
			::String tmp2 = path;
			openFile(tmp2);
		}
	}
...
::String target = __o_target.Default(HX_HCSTRING("_blank","\x95","\x26","\xd9","\xb0"));
{
		bool tmp = (url != null());
		if ((tmp)){
			Dynamic tmp1 = ::lime::_system::JNI_obj::createStaticMethod(HX_HCSTRING("org/haxe/lime/GameActivity","\x1d","\x61","\xc7","\xa4"),HX_HCSTRING("openURL","\xc5","\xbd","\x35","\x40"),HX_HCSTRING("(Ljava/lang/String;Ljava/lang/String;)V","\x49","\x45","\xe8","\x06"),null(),null());
			Dynamic openURL = tmp1;
			::String tmp2 = url;
			::String tmp3 = target;
			openURL(tmp2,tmp3);
		}
...
::String System_obj::__getDirectory( int type){
	...
	if ((tmp2)){
		...
		::String seperator = HX_HCSTRING("/","\x2f","\x00","\x00","\x00");
		bool tmp4 = (path != null());
		bool tmp5 = tmp4;
		bool tmp6;
		if ((tmp5)){
