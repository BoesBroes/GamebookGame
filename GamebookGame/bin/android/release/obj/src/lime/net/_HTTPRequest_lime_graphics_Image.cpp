...
{
HX_STACK_FRAME("lime.net._HTTPRequest_lime_graphics_Image","new",0xb2d90076,"lime.net._HTTPRequest_lime_graphics_Image.new","lime/_macros/HTTPRequestMacro.hx",131,0xa1943d76)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< _HTTPRequest_lime_graphics_Image_obj > _result_ = new _HTTPRequest_lime_graphics_Image_obj();
...
Dynamic _HTTPRequest_lime_graphics_Image_obj::fromBytes( ::haxe::io::Bytes bytes){
	HX_STACK_FRAME("lime.net._HTTPRequest_lime_graphics_Image","fromBytes",0xef825737,"lime.net._HTTPRequest_lime_graphics_Image.fromBytes","lime/graphics/Image.hx",876,0xc7b862ad)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(876)
	::haxe::io::Bytes tmp = bytes;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(876)
	::lime::graphics::Image tmp1 = ::lime::graphics::Image_obj::fromBytes(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(876)
	return tmp1;
}
...
Dynamic _HTTPRequest_lime_graphics_Image_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
