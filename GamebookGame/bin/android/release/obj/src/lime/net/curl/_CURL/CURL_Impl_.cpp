...
int CURL_Impl__obj::getDate( ::String date,int now){
	...
	HX_STACK_LINE(23)
	return ((int)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_getdate.call(date,((Float)(now)))));
}
...
::String CURL_Impl__obj::version( ){
	...
	HX_STACK_LINE(54)
	return ((Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version.call()));
}
...
Dynamic CURL_Impl__obj::versionInfo( int type){
	...
	HX_STACK_LINE(65)
	{
		...
		HX_STACK_LINE(65)
		tmp = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_curl_version_info.call(type1);
	}
	HX_STACK_LINE(65)
	return tmp;
}
