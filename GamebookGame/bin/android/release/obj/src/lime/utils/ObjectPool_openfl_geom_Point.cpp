...
{
HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","new",0xd511c7a0,"lime.utils.ObjectPool_openfl_geom_Point.new","lime/utils/ObjectPool.hx",22,0xc114d76b)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< ObjectPool_openfl_geom_Point_obj > _result_ = new ObjectPool_openfl_geom_Point_obj();
...
{
		HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","add",0xd507e961,"lime.utils.ObjectPool_openfl_geom_Point.add","lime/utils/ObjectPool.hx",48,0xc114d76b)
		HX_STACK_THIS(this)
		...
		if ((tmp)){
			...
			HX_STACK_LINE(52)
			::openfl::geom::Point tmp2 = object;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(52)
			tmp1->remove(tmp2);
			HX_STACK_LINE(53)
			::List tmp3 = this->__inactiveObjects;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(53)
			::openfl::geom::Point tmp4 = object;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(53)
			tmp3->remove(tmp4);
			HX_STACK_LINE(55)
			::openfl::geom::Point tmp5 = object;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(55)
			this->clean(tmp5);
			HX_STACK_LINE(57)
			::List tmp6 = this->__inactiveObjects;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(57)
			::openfl::geom::Point tmp7 = object;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(57)
			tmp6->add(tmp7);
		}
	}
...
Void run(::openfl::geom::Point object){
{
		HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","clean",0x41f5b8c9,"lime.utils.ObjectPool_openfl_geom_Point.clean","lime/utils/ObjectPool.hx",64,0xc114d76b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(object,"object")
	}
return null();
...
{
		HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","clear",0x41f5b8cd,"lime.utils.ObjectPool_openfl_geom_Point.clear","lime/utils/ObjectPool.hx",71,0xc114d76b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
...
::openfl::geom::Point run(){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","create",0xe97377bc,"lime.utils.ObjectPool_openfl_geom_Point.create","lime/utils/ObjectPool.hx",81,0xc114d76b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(81)
	return null();
}
...
::openfl::geom::Point ObjectPool_openfl_geom_Point_obj::get( ){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","get",0xd50c77d6,"lime.utils.ObjectPool_openfl_geom_Point.get","lime/utils/ObjectPool.hx",86,0xc114d76b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(88)
	::openfl::geom::Point object = null();		HX_STACK_VAR(object,"object");
	HX_STACK_LINE(90)
	::List tmp = this->__inactiveObjects;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(90)
	...
	if ((tmp2)){
		...
		::List tmp3 = this->__inactiveObjects;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(92)
		::openfl::geom::Point tmp4 = tmp3->pop();		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(92)
		object = tmp4;
		HX_STACK_LINE(93)
		::List tmp5 = this->__activeObjects;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(93)
		::openfl::geom::Point tmp6 = object;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(93)
		tmp5->add(tmp6);
	}
	else{
		...
		if ((tmp6)){
			HX_STACK_LINE(97)
			::openfl::geom::Point tmp7 = this->create();		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(97)
			object = tmp7;
			HX_STACK_LINE(99)
			...
			if ((tmp8)){
				...
				HX_STACK_LINE(101)
				::openfl::geom::Point tmp10 = object;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(101)
				tmp9->add(tmp10);
			}
		}
	...
	HX_STACK_LINE(107)
	::openfl::geom::Point tmp3 = object;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(107)
	return tmp3;
}
...
{
		HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","release",0xa3181d07,"lime.utils.ObjectPool_openfl_geom_Point.release","lime/utils/ObjectPool.hx",112,0xc114d76b)
		HX_STACK_THIS(this)
		HX_STACK_ARG(object,"object")
		HX_STACK_LINE(114)
		::List tmp = this->__activeObjects;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(114)
		::openfl::geom::Point tmp1 = object;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(114)
		...
		if ((tmp2)){
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(120)
				::openfl::geom::Point tmp9 = object;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(120)
				tmp8->add(tmp9);
			}
		}
...
int ObjectPool_openfl_geom_Point_obj::get_activeObjects( ){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","get_activeObjects",0x0c10e645,"lime.utils.ObjectPool_openfl_geom_Point.get_activeObjects","lime/utils/ObjectPool.hx",136,0xc114d76b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(138)
	::List tmp = this->__activeObjects;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(138)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Point_obj,get_activeObjects,return )

int ObjectPool_openfl_geom_Point_obj::get_inactiveObjects( ){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","get_inactiveObjects",0x62225300,"lime.utils.ObjectPool_openfl_geom_Point.get_inactiveObjects","lime/utils/ObjectPool.hx",143,0xc114d76b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(145)
	::List tmp = this->__inactiveObjects;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(145)
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_openfl_geom_Point_obj,get_inactiveObjects,return )

Dynamic ObjectPool_openfl_geom_Point_obj::get_size( ){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","get_size",0x67281d0a,"lime.utils.ObjectPool_openfl_geom_Point.get_size","lime/utils/ObjectPool.hx",150,0xc114d76b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(152)
...
Dynamic ObjectPool_openfl_geom_Point_obj::set_size( Dynamic value){
	HX_STACK_FRAME("lime.utils.ObjectPool_openfl_geom_Point","set_size",0x1585767e,"lime.utils.ObjectPool_openfl_geom_Point.set_size","lime/utils/ObjectPool.hx",157,0xc114d76b)
	HX_STACK_THIS(this)
	...
	if ((tmp)){
		...
		HX_STACK_LINE(188)
		::openfl::geom::Point object;		HX_STACK_VAR(object,"object");
		HX_STACK_LINE(190)
		while((true)){
			HX_STACK_LINE(190)
			...
			HX_STACK_LINE(192)
			::openfl::geom::Point tmp8 = this->create();		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(192)
			object = tmp8;
			HX_STACK_LINE(194)
			...
			if ((tmp9)){
				...
				HX_STACK_LINE(196)
				::openfl::geom::Point tmp11 = object;		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(196)
				tmp10->add(tmp11);
				HX_STACK_LINE(197)
				(current)++;
...
Dynamic ObjectPool_openfl_geom_Point_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic ObjectPool_openfl_geom_Point_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::List*/ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,__activeObjects),HX_HCSTRING("__activeObjects","\x8e","\xec","\xca","\xc1")},
	{hx::fsObject /*::List*/ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,__inactiveObjects),HX_HCSTRING("__inactiveObjects","\x89","\x3d","\x21","\x7f")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ObjectPool_openfl_geom_Point_obj,__size),HX_HCSTRING("__size","\xe1","\x03","\x4c","\xfb")},
