...
::haxe::io::Bytes Deflate_obj::compress( ::haxe::io::Bytes bytes){
	Dynamic tmp;
	{
		...
		Dynamic bytes1 = tmp1;
		tmp = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_deflate_compress.call(hx::DynamicPtr(bytes),hx::DynamicPtr(bytes1));
	}
	return tmp;
}
...
::haxe::io::Bytes Deflate_obj::decompress( ::haxe::io::Bytes bytes){
	Dynamic tmp;
	{
		::haxe::io::Bytes tmp1 = ::haxe::io::Bytes_obj::alloc((int)0);
		Dynamic bytes1 = tmp1;
		tmp = ::lime::_backend::native::NativeCFFI_obj::cffi_lime_deflate_decompress.call(hx::DynamicPtr(bytes),hx::DynamicPtr(bytes1));
	}
	return tmp;
}
