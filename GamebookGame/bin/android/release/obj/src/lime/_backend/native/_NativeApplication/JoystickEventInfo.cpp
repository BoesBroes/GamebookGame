...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","new",0x2df84fa1,"lime._backend.native._NativeApplication.JoystickEventInfo.new","lime/_backend/native/NativeApplication.hx",834,0xb13849fd)
HX_STACK_THIS(this)
...
hx::ObjectPtr< JoystickEventInfo_obj > JoystickEventInfo_obj::__new(Dynamic type,hx::Null< int >  __o_id,hx::Null< int >  __o_index,hx::Null< int >  __o_value,hx::Null< Float >  __o_x,hx::Null< Float >  __o_y)
...
::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",846,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(848)
	...
	HX_STACK_LINE(848)
	int tmp3 = this->value;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(848)
