...
int NativeApplication_obj::exec( ){
	...
	::lime::_backend::native::NativeCFFI_obj::cffi_lime_sensor_event_manager_register.call(hx::DynamicPtr(this->handleSensorEvent_dyn()),hx::DynamicPtr(this->sensorEventInfo));
...
Void NativeApplication_obj::handleKeyEvent( ){
{
		...
		if ((tmp4)){
			...
			bool tmp9 = (keyCode == (int)1073742094);
			bool tmp10 = tmp9;
			bool tmp11;
			if ((tmp10)){
			...
			bool tmp14;
			if ((tmp13)){
				bool tmp15 = window->onKeyUp->canceled;
				bool tmp16 = tmp15;
				bool tmp17 = tmp16;
				tmp14 = !(tmp17);
			}
