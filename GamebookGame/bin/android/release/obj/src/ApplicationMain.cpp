...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(23)
		::String projectName = HX_HCSTRING("GamebookGame","\xcd","\xee","\x24","\x43");		HX_STACK_VAR(projectName,"projectName");
		...
		struct _Function_1_2{
			inline static Dynamic Block( Dynamic &tmp){
				...
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("allowHighDPI","\x92","\x07","\xa2","\xb4") , true,false);
		...
		struct _Function_1_3{
			inline static Dynamic Block( Dynamic &tmp1){
				...
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("build","\x2e","\xdb","\xea","\xba") , HX_HCSTRING("6","\x36","\x00","\x00","\x00"),false);
					__result->Add(HX_HCSTRING("company","\x3d","\x15","\x69","\x83") , HX_HCSTRING("L'Jonathanos","\x38","\xd3","\xbc","\x0b"),false);
					__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("GamebookGame","\xcd","\xee","\x24","\x43"),false);
