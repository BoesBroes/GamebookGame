...
class HXCPP_CLASS_ATTRIBUTES  Matrix4_Impl__obj : public hx::Object{
	...
	public:
		...
		static ::lime::utils::ArrayBufferView __getAxisRotation( ::lime::utils::ArrayBufferView this1,Float x,Float y,Float z,Float degrees);
		static Dynamic __getAxisRotation_dyn();

		static Void __swap( ::lime::utils::ArrayBufferView this1,int a,int b);
		static Dynamic __swap_dyn();
