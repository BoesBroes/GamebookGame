...
class HXCPP_CLASS_ATTRIBUTES  TextField_obj : public ::openfl::display::InteractiveObject_obj{
	...
	public:
		...
		static ::haxe::ds::StringMap __missingFontWarning;
		...
		bool __showCursor;
		::openfl::_internal::symbols::DynamicTextSymbol __symbol;
		::String __text;
		::String __htmlText;
		...
		virtual Void __caretBeginningOfLine( );
		Dynamic __caretBeginningOfLine_dyn();

		virtual Void __caretEndOfLine( );
		Dynamic __caretEndOfLine_dyn();

		virtual Void __caretNextCharacter( );
		Dynamic __caretNextCharacter_dyn();

		virtual Void __caretNextLine( Dynamic lineIndex,Dynamic caretIndex);
		Dynamic __caretNextLine_dyn();

		virtual Void __caretPreviousCharacter( );
		Dynamic __caretPreviousCharacter_dyn();

		virtual Void __caretPreviousLine( Dynamic lineIndex,Dynamic caretIndex);
		Dynamic __caretPreviousLine_dyn();

		virtual bool __dispatch( ::openfl::events::Event event);

		virtual Void __fromSymbol( ::openfl::_internal::swf::SWFLite swf,::openfl::_internal::symbols::DynamicTextSymbol symbol);
		...
		virtual int __getCharIndexOnDifferentLine( int charIndex,int lineIndex);
		Dynamic __getCharIndexOnDifferentLine_dyn();

		virtual ::lime::ui::MouseCursor __getCursor( );

		virtual ::openfl::_internal::text::TextLayoutGroup __getGroup( Float x,Float y,hx::Null< bool >  precise);
		Dynamic __getGroup_dyn();
