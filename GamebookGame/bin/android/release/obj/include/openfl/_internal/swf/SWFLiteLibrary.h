...
class HXCPP_CLASS_ATTRIBUTES  SWFLiteLibrary_obj : public ::openfl::utils::AssetLibrary_obj{
	...
	public:
		...
		virtual Void __copyChannel( ::lime::graphics::Image image,::lime::graphics::Image alpha);
		Dynamic __copyChannel_dyn();

		virtual Void __fromManifest( ::lime::utils::AssetManifest manifest);

		virtual ::lime::app::Future __load( );
		Dynamic __load_dyn();

		virtual ::lime::app::Future __loadImage( ::String id);
		Dynamic __loadImage_dyn();
