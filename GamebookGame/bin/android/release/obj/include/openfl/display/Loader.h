...
class HXCPP_CLASS_ATTRIBUTES  Loader_obj : public ::openfl::display::DisplayObjectContainer_obj{
	...
	public:
		...
		virtual Void __dispatchError( ::String text);
		Dynamic __dispatchError_dyn();

		virtual Void BitmapData_onError( Dynamic error);
		...
		virtual Void BitmapData_onProgress( int bytesLoaded,int bytesTotal);
		Dynamic BitmapData_onProgress_dyn();

		virtual Void loader_onComplete( ::openfl::events::Event event);
		Dynamic loader_onComplete_dyn();

		virtual Void loader_onError( ::openfl::events::IOErrorEvent event);
		Dynamic loader_onError_dyn();

		virtual Void loader_onProgress( ::openfl::events::ProgressEvent event);
