...
class HXCPP_CLASS_ATTRIBUTES  DisplayObject_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		::openfl::display::Bitmap __cacheBitmap;
		::openfl::display::BitmapData __cacheBitmapData;
		bool __cacheBitmapRender;
		...
		bool __interactive;
		bool __isMask;
		::openfl::display::LoaderInfo __loaderInfo;
		...
		::openfl::geom::Matrix __renderTransformCache;
		...
		virtual bool __dispatchChildren( ::openfl::events::Event event,::openfl::_Vector::ObjectVector stack);
		Dynamic __dispatchChildren_dyn();

		virtual bool __dispatchEvent( ::openfl::events::Event event);

		virtual Void __dispatchStack( ::openfl::events::Event event,Array< ::Dynamic > stack);
		Dynamic __dispatchStack_dyn();
		...
		virtual Void __setParentRenderDirty( );
		Dynamic __setParentRenderDirty_dyn();
		...
		virtual Void __updateCacheBitmap( ::openfl::_internal::renderer::RenderSession renderSession);
		Dynamic __updateCacheBitmap_dyn();
		...
		virtual ::openfl::display::LoaderInfo get_loaderInfo( );
