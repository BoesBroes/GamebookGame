...
class HXCPP_CLASS_ATTRIBUTES  IBitmapDrawable_obj : public hx::Interface{
	public:
		...
		virtual Void __getBounds( ::openfl::geom::Rectangle rect,::openfl::geom::Matrix matrix)=0;
virtual Dynamic __getBounds_dyn()=0;
...
class IBitmapDrawable_delegate_ : public IBitmapDrawable_obj
{
	...
	public:
		...
		Void __getBounds( ::openfl::geom::Rectangle rect,::openfl::geom::Matrix matrix) { return mDelegate->__getBounds(rect,matrix);}
		Dynamic __getBounds_dyn() { return mDelegate->__getBounds_dyn();}
