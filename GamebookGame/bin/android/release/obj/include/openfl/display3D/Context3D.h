...
class HXCPP_CLASS_ATTRIBUTES  Context3D_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		::lime::graphics::opengl::GLObject __depthRenderBuffer;
		::lime::graphics::opengl::GLObject __depthStencilRenderBuffer;
		::lime::utils::ArrayBufferView __fragmentConstants;
		::lime::graphics::opengl::GLObject __framebuffer;
		int __frameCount;
		int __maxAnisotropyCubeTexture;
		int __maxAnisotropyTexture2D;
		...
		::lime::graphics::opengl::GLObject __stencilRenderBuffer;
		bool __supportsAnisotropicFiltering;
		...
		virtual ::openfl::display3D::textures::VideoTexture createVideoTexture( );
