...
::openfl::ui::GameInputDevice GameInput_obj::__getDevice( ::lime::ui::Gamepad gamepad){
	...
	if ((tmp4)){
		HX_STACK_LINE(54)
		::openfl::ui::GameInputDevice tmp5 = ::openfl::ui::GameInputDevice_obj::__new(((::String)(((Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_guid.call(gamepad->id))))),((::String)(((Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gamepad_get_device_name.call(gamepad->id))))));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(54)
