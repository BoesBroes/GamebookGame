...
int GraphicsDataType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e")) return 6;
...
int GraphicsDataType_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_HCSTRING("STROKE","\xb8","\x5f","\xb7","\xc3")) return 0;
	if (inName==HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e")) return 0;
...
Dynamic GraphicsDataType_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e")) return TRIANGLE_PATH;
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e"),
	::String(null()) };
...
hx::Static(TRIANGLE_PATH) = hx::CreateEnum< GraphicsDataType_obj >(HX_HCSTRING("TRIANGLE_PATH","\xbc","\xe5","\x7d","\x7e"),6);
}
