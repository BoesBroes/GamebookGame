...
::String UncaughtErrorEvent_obj::toString( ){
	HX_STACK_FRAME("openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",32,0x0dad2340)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
