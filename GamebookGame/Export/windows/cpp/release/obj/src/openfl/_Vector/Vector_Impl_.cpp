...
::openfl::_Vector::ObjectVector Vector_Impl__obj::reverse( ::openfl::_Vector::IVector this1){
	HX_STACK_FRAME("openfl._Vector.Vector_Impl_","reverse",0xc6996881,"openfl._Vector.Vector_Impl_.reverse","openfl/Vector.hx",90,0x4a01873c)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(92)
	::openfl::_Vector::IVector tmp = this1->reverse();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(92)
	::openfl::_Vector::ObjectVector tmp1 = ((::openfl::_Vector::ObjectVector)(tmp));		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(92)
	return tmp1;
