...
::openfl::_Vector::IVector ObjectVector_obj::concat( ::openfl::_Vector::IVector a){
	bool tmp = (a == null());
	if ((tmp)){
		::openfl::_Vector::ObjectVector tmp1 = ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),this->__array->__Field(HX_HCSTRING("copy","\xb5","\xbb","\xc4","\x41"), hx::paccDynamic )());
		return tmp1;
	}
	else{
		::openfl::_Vector::ObjectVector tmp1;
		tmp1 = hx::TCast< ::openfl::_Vector::ObjectVector >::cast(a);
		::openfl::_Vector::ObjectVector tmp2 = ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),this->__array->__Field(HX_HCSTRING("concat","\x14","\x09","\xd0","\xc7"), hx::paccDynamic )(((cpp::ArrayBase)(tmp1->__array))));
		return tmp2;
	}
	return null();
}
...
::openfl::_Vector::IVector ObjectVector_obj::copy( ){
	::openfl::_Vector::ObjectVector tmp = ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),this->__array->__Field(HX_HCSTRING("copy","\xb5","\xbb","\xc4","\x41"), hx::paccDynamic )());
	return tmp;
}
...
Dynamic ObjectVector_obj::get( int index){
	Dynamic tmp = this->__array->__GetItem(index);
	return tmp;
}
...
::openfl::_Vector::IVector ObjectVector_obj::reverse( ){
...
Dynamic endIndex = __o_endIndex.Default(16777215);
{
		...
		::openfl::_Vector::ObjectVector tmp2 = ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),this->__array->__Field(HX_HCSTRING("slice","\x52","\xc4","\xc7","\x7e"), hx::paccDynamic )(tmp,tmp1));
		return tmp2;
	}
}
...
::openfl::_Vector::IVector ObjectVector_obj::splice( int pos,int len){
	int tmp = pos;
	int tmp1 = len;
	::openfl::_Vector::ObjectVector tmp2 = ::openfl::_Vector::ObjectVector_obj::__new(null(),null(),this->__array->__Field(HX_HCSTRING("splice","\x7c","\x85","\x9e","\xbf"), hx::paccDynamic )(tmp,tmp1));
	return tmp2;
}
