...
::openfl::events::Event KeyboardEvent_obj::clone( ){
	...
	HX_STACK_LINE(44)
	::openfl::events::IEventDispatcher tmp12 = this->target;		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(44)
	event->target = tmp12;
	HX_STACK_LINE(45)
	::openfl::events::IEventDispatcher tmp13 = this->currentTarget;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(45)
