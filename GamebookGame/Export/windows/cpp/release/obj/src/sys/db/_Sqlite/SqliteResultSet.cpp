...
{
HX_STACK_FRAME("sys.db._Sqlite.SqliteResultSet","new",0x31627399,"sys.db._Sqlite.SqliteResultSet.new","S:\\haxe\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",108,0x878fb761)
HX_STACK_THIS(this)
HX_STACK_ARG(r,"r")
{
	HX_STACK_LINE(109)
...
bool SqliteResultSet_obj::hasNext( ){
	HX_STACK_FRAME("sys.db._Sqlite.SqliteResultSet","hasNext",0x0ab9d926,"sys.db._Sqlite.SqliteResultSet.hasNext","S:\\haxe\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",131,0x878fb761)
	HX_STACK_THIS(this)
	HX_STACK_LINE(132)
...
Dynamic SqliteResultSet_obj::next( ){
	HX_STACK_FRAME("sys.db._Sqlite.SqliteResultSet","next",0x04c2b39a,"sys.db._Sqlite.SqliteResultSet.next","S:\\haxe\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",139,0x878fb761)
	HX_STACK_THIS(this)
	HX_STACK_LINE(140)
