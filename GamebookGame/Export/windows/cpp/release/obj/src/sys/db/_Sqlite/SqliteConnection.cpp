...
{
HX_STACK_FRAME("sys.db._Sqlite.SqliteConnection","new",0xf8a8646e,"sys.db._Sqlite.SqliteConnection.new","S:\\haxe\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",28,0x878fb761)
HX_STACK_THIS(this)
...
::sys::db::ResultSet SqliteConnection_obj::request( ::String s){
	HX_STACK_FRAME("sys.db._Sqlite.SqliteConnection","request",0x544f925d,"sys.db._Sqlite.SqliteConnection.request","S:\\haxe\\haxe\\std/cpp/_std/sys/db/Sqlite.hx",37,0x878fb761)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(37)
	try
