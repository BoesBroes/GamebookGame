...
{
HX_STACK_FRAME("_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","S:\\haxe\\haxe\\std/List.hx",244,0xa22ca7ff)
HX_STACK_THIS(this)
...
bool ListIterator_obj::hasNext( ){
	HX_STACK_FRAME("_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","S:\\haxe\\haxe\\std/List.hx",249,0xa22ca7ff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
...
Dynamic ListIterator_obj::next( ){
	HX_STACK_FRAME("_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","S:\\haxe\\haxe\\std/List.hx",253,0xa22ca7ff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
