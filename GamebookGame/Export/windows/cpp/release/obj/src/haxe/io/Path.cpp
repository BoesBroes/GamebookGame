...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","S:\\haxe\\haxe\\std/haxe/io/Path.hx",76,0x2e682438)
HX_STACK_THIS(this)
...
::String Path_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","S:\\haxe\\haxe\\std/haxe/io/Path.hx",114,0x2e682438)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
...
::String Path_obj::withoutDirectory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","S:\\haxe\\haxe\\std/haxe/io/Path.hx",134,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(135)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","S:\\haxe\\haxe\\std/haxe/io/Path.hx",147,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(148)
	::haxe::io::Path tmp = ::haxe::io::Path_obj::__new(path);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(148)
...
::String Path_obj::join( Array< ::String > paths){
	HX_STACK_FRAME("haxe.io.Path","join",0x05c781f3,"haxe.io.Path.join","S:\\haxe\\haxe\\std/haxe/io/Path.hx",189,0x2e682438)
	HX_STACK_ARG(paths,"paths")

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	int __ArgCount() const { return 1; }
	bool run(::String s){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","S:\\haxe\\haxe\\std/haxe/io/Path.hx",190,0x2e682438)
		HX_STACK_ARG(s,"s")
		{
			HX_STACK_LINE(190)
...
::String Path_obj::normalize( ::String path){
	HX_STACK_FRAME("haxe.io.Path","normalize",0x585a68e4,"haxe.io.Path.normalize","S:\\haxe\\haxe\\std/haxe/io/Path.hx",210,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(211)
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","S:\\haxe\\haxe\\std/haxe/io/Path.hx",265,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(266)
...
::String Path_obj::removeTrailingSlashes( ::String path){
	HX_STACK_FRAME("haxe.io.Path","removeTrailingSlashes",0x2dc73462,"haxe.io.Path.removeTrailingSlashes","S:\\haxe\\haxe\\std/haxe/io/Path.hx",290,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(291)
	while((true)){
		HX_STACK_LINE(292)
...
bool Path_obj::isAbsolute( ::String path){
	HX_STACK_FRAME("haxe.io.Path","isAbsolute",0xb396db4a,"haxe.io.Path.isAbsolute","S:\\haxe\\haxe\\std/haxe/io/Path.hx",304,0x2e682438)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(305)
	::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(305)
