...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",51,0xe5b4ed16)
HX_STACK_THIS(this)
{
}
;
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",54,0xe5b4ed16)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",57,0xe5b4ed16)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(58)
...
bool ObjectMap_obj::exists( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","exists",0xc8930ca4,"haxe.ds.ObjectMap.exists","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",61,0xe5b4ed16)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(62)
...
bool ObjectMap_obj::remove( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",65,0xe5b4ed16)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(66)
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",69,0xe5b4ed16)
	HX_STACK_THIS(this)
	HX_STACK_LINE(70)
...
Dynamic ObjectMap_obj::iterator( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","iterator",0x61fc7ab6,"haxe.ds.ObjectMap.iterator","S:\\haxe\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",74,0xe5b4ed16)
	HX_STACK_THIS(this)
	HX_STACK_LINE(75)
