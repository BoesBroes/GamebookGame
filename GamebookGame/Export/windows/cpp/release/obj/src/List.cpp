...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","S:\\haxe\\haxe\\std/List.hx",41,0xa22ca7ff)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","S:\\haxe\\haxe\\std/List.hx",49,0xa22ca7ff)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("List","push",0xebb5efca,"List.push","S:\\haxe\\haxe\\std/List.hx",64,0xa22ca7ff)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(68)
...
Dynamic List_obj::pop( ){
	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","S:\\haxe\\haxe\\std/List.hx",100,0xa22ca7ff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
	bool tmp = (this->h == null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(101)
...
Void List_obj::clear( ){
{
		HX_STACK_FRAME("List","clear",0xd148c59d,"List.clear","S:\\haxe\\haxe\\std/List.hx",124,0xa22ca7ff)
		HX_STACK_THIS(this)
		HX_STACK_LINE(125)
		this->h = null();
		HX_STACK_LINE(126)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","S:\\haxe\\haxe\\std/List.hx",138,0xa22ca7ff)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
...
::_List::ListIterator List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","S:\\haxe\\haxe\\std/List.hx",161,0xa22ca7ff)
	HX_STACK_THIS(this)
	HX_STACK_LINE(162)
