...
::lime::graphics::opengl::GLObject GLShader_Impl__obj::fromInt( int id){
	HX_STACK_FRAME("lime.graphics.opengl._GLShader.GLShader_Impl_","fromInt",0xb772897b,"lime.graphics.opengl._GLShader.GLShader_Impl_.fromInt","lime/graphics/opengl/GLShader.hx",12,0x4f56a5be)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(14)
	int tmp = id;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(14)
	::lime::graphics::opengl::GLObject tmp1 = ::lime::graphics::opengl::GLObject_obj::fromInt((int)2,tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(14)
	return tmp1;
}
