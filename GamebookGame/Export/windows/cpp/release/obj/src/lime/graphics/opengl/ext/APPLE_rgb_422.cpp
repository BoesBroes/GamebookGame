...
{
HX_STACK_FRAME("lime.graphics.opengl.ext.APPLE_rgb_422","new",0x2a5502cd,"lime.graphics.opengl.ext.APPLE_rgb_422.new","lime/graphics/opengl/ext/APPLE_rgb_422.hx",6,0xcbee61e5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(11)
	this->UNSIGNED_SHORT_8_8_REV_APPLE = (int)34235;
	HX_STACK_LINE(10)
	this->UNSIGNED_SHORT_8_8_APPLE = (int)34234;
	HX_STACK_LINE(9)
	this->RGB_422_APPLE = (int)35359;
}
;
	return null();
}
...
hx::ObjectPtr< APPLE_rgb_422_obj > APPLE_rgb_422_obj::__new()
{  hx::ObjectPtr< APPLE_rgb_422_obj > _result_ = new APPLE_rgb_422_obj();
...
Dynamic APPLE_rgb_422_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
		if (HX_FIELD_EQ(inName,"RGB_422_APPLE") ) { return RGB_422_APPLE; }
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"UNSIGNED_SHORT_8_8_APPLE") ) { return UNSIGNED_SHORT_8_8_APPLE; }
		break;
	case 28:
		if (HX_FIELD_EQ(inName,"UNSIGNED_SHORT_8_8_REV_APPLE") ) { return UNSIGNED_SHORT_8_8_REV_APPLE; }
	}
	return super::__Field(inName,inCallProp);
}

Dynamic APPLE_rgb_422_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
