...
{
HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","new",0xdf7fef3a,"lime.app._Event_Int_Float_Float_Void.new","lime/app/Event.hx",31,0xbda45bec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(34)
	this->canceled = false;
...
{  hx::ObjectPtr< _Event_Int_Float_Float_Void_obj > _result_ = new _Event_Int_Float_Float_Void_obj();
...
int priority = __o_priority.Default(0);
	HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","add",0xdf7610fb,"lime.app._Event_Int_Float_Float_Void.add","lime/app/Event.hx",43,0xbda45bec)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","cancel",0x010712e0,"lime.app._Event_Int_Float_Float_Void.cancel","lime/app/Event.hx",221,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(221)
		this->canceled = true;
	}
...
bool _Event_Int_Float_Float_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","has",0xdf7b5e34,"lime.app._Event_Int_Float_Float_Void.has","lime/app/Event.hx",257,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(260)
	{
...
{
		HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","remove",0x4d5bc1aa,"lime.app._Event_Int_Float_Float_Void.remove","lime/app/Event.hx",272,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(275)
...
{
		HX_STACK_FRAME("lime.app._Event_Int_Float_Float_Void","dispatch",0x9e5799a0,"lime.app._Event_Int_Float_Float_Void.dispatch","lime/_macros/EventMacro.hx",91,0x8c7af009)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(a1,"a1")
		HX_STACK_ARG(a2,"a2")
...
Dynamic _Event_Int_Float_Float_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic _Event_Int_Float_Float_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(_Event_Int_Float_Float_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(_Event_Int_Float_Float_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(_Event_Int_Float_Float_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
