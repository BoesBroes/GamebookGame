...
::lime::math::Rectangle Rectangle_obj::clone( ){
	...
	::lime::math::Rectangle tmp4 = ::lime::math::Rectangle_obj::__new(tmp,tmp1,tmp2,tmp3);
	return tmp4;
}
...
bool Rectangle_obj::equals( ::lime::math::Rectangle toCompare){
	...
	bool tmp6;
	if ((tmp5)){
		Float tmp7 = this->width;
		Float tmp8 = tmp7;
		Float tmp9 = tmp8;
		Float tmp10 = toCompare->width;
		tmp6 = (tmp9 == tmp10);
	}
	else{
		tmp6 = false;
	...
	bool tmp7;
	if ((tmp6)){
		Float tmp8 = this->height;
		Float tmp9 = tmp8;
		Float tmp10 = toCompare->height;
		tmp7 = (tmp9 == tmp10);
	}
	else{
		tmp7 = false;
...
::lime::math::Rectangle Rectangle_obj::intersection( ::lime::math::Rectangle toIntersect){
	...
	bool tmp8 = (x1 <= x0);
	if ((tmp8)){
		::lime::math::Rectangle tmp9 = ::lime::math::Rectangle_obj::__new(null(),null(),null(),null());
		return tmp9;
	}
	Float tmp9 = this->y;
	...
	bool tmp17 = (y1 <= y0);
	if ((tmp17)){
		::lime::math::Rectangle tmp18 = ::lime::math::Rectangle_obj::__new(null(),null(),null(),null());
		return tmp18;
	}
	Float tmp18 = x0;
	Float tmp19 = y0;
	Float tmp20 = (x1 - x0);
	Float tmp21 = (y1 - y0);
	::lime::math::Rectangle tmp22 = ::lime::math::Rectangle_obj::__new(tmp18,tmp19,tmp20,tmp21);
	return tmp22;
}
...
::lime::math::Rectangle Rectangle_obj::transform( ::lime::math::Matrix3 m){
	...
	Float tmp86 = (tx1 - tx0);
	Float tmp87 = (ty1 - ty0);
	::lime::math::Rectangle tmp88 = ::lime::math::Rectangle_obj::__new(tmp84,tmp85,tmp86,tmp87);
	return tmp88;
}
...
::lime::math::Rectangle Rectangle_obj::_union( ::lime::math::Rectangle toUnion){
	...
	if ((tmp3)){
		::lime::math::Rectangle tmp4 = toUnion->clone();
		return tmp4;
	}
	else{
		...
		if ((tmp6)){
			::lime::math::Rectangle tmp7 = this->clone();
			return tmp7;
		}
	}
	Float tmp4 = this->x;
	...
	Float tmp22 = (x1 - x0);
	Float tmp23 = (y1 - y0);
	::lime::math::Rectangle tmp24 = ::lime::math::Rectangle_obj::__new(tmp20,tmp21,tmp22,tmp23);
	return tmp24;
}
...
::lime::math::Vector2 Rectangle_obj::set_bottomRight( ::lime::math::Vector2 p){
	...
	Float tmp5 = (tmp3 - tmp4);
	this->height = tmp5;
	::lime::math::Vector2 tmp6 = p->clone();
	return tmp6;
}
