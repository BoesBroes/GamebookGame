...
int ArrayBufferIO_obj::getInt16( ::haxe::io::Bytes buffer,int byteOffset){
	HX_STACK_FRAME("lime.utils.ArrayBufferIO","getInt16",0x764c5d83,"lime.utils.ArrayBufferIO.getInt16","lime/utils/ArrayBufferView.hx",488,0xb543acf8)
...
int ArrayBufferIO_obj::getInt16_BE( ::haxe::io::Bytes buffer,int byteOffset){
	HX_STACK_FRAME("lime.utils.ArrayBufferIO","getInt16_BE",0x50eb063f,"lime.utils.ArrayBufferIO.getInt16_BE","lime/utils/ArrayBufferView.hx",505,0xb543acf8)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_ARG(byteOffset,"byteOffset")
	HX_STACK_LINE(508)
	int tmp = ::__hxcpp_memory_get_i16(buffer->b,byteOffset);		HX_STACK_VAR(tmp,"tmp");
