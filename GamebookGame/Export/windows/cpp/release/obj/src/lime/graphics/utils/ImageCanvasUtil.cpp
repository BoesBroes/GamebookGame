...
Void ImageCanvasUtil_obj::scroll( ::lime::graphics::Image image,int x,int y){
{
		...
		HX_STACK_LINE(372)
		::lime::graphics::Image copy = tmp3;		HX_STACK_VAR(copy,"copy");
		HX_STACK_LINE(374)
		::lime::graphics::Image tmp4 = image;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(374)
		::lime::graphics::utils::ImageCanvasUtil_obj::convertToCanvas(tmp4,true);
		HX_STACK_LINE(376)
		...
		HX_STACK_LINE(377)
		tmp6->__Field(HX_HCSTRING("drawImage","\xb7","\x54","\x74","\x85"), hx::paccDynamic )(copy->get_src(),x,y);
		HX_STACK_LINE(379)
		image->dirty = true;
		HX_STACK_LINE(380)
		(image->version)++;
...
{
		HX_STACK_FRAME("lime.graphics.utils.ImageCanvasUtil","sync",0x85fe4d9b,"lime.graphics.utils.ImageCanvasUtil.sync","lime/graphics/utils/ImageCanvasUtil.hx",412,0x78efca71)
		HX_STACK_ARG(image,"image")
		HX_STACK_ARG(clear,"clear")
		HX_STACK_LINE(414)
