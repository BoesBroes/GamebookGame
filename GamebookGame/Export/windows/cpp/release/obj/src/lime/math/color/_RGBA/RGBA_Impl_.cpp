					...
					if ((tmp4)){
						...
						if ((tmp5)){
							...
							HX_STACK_LINE(27)
							{
								...
								HX_STACK_LINE(27)
								int tmp9 = hx::Mod(in_byteOffset,_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(27)
								...
								HX_STACK_LINE(27)
								_this->__FieldRef(HX_HCSTRING("byteOffset","\xbb","\x20","\x44","\x38")) = in_byteOffset;
								HX_STACK_LINE(27)
					...
					if ((tmp5)){
						...
						if ((tmp6)){
							...
							HX_STACK_LINE(35)
							{
								...
								HX_STACK_LINE(35)
								int tmp10 = hx::Mod(in_byteOffset,_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(35)
