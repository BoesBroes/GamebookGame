...
bool LogLevel_Impl__obj::gt( int a,int b){
	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","gt",0x45da0308,"lime.utils._Log.LogLevel_Impl_.gt","lime/utils/Log.hx",164,0x300eb2b2)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(164)
...
bool LogLevel_Impl__obj::gte( int a,int b){
	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","gte",0xd8e8a45d,"lime.utils._Log.LogLevel_Impl_.gte","lime/utils/Log.hx",165,0x300eb2b2)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(165)
	bool tmp = (a >= b);		HX_STACK_VAR(tmp,"tmp");
...
bool LogLevel_Impl__obj::lt( int a,int b){
	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","lt",0x45da0763,"lime.utils._Log.LogLevel_Impl_.lt","lime/utils/Log.hx",166,0x300eb2b2)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(166)
	bool tmp = (a < b);		HX_STACK_VAR(tmp,"tmp");
...
bool LogLevel_Impl__obj::lte( int a,int b){
	HX_STACK_FRAME("lime.utils._Log.LogLevel_Impl_","lte",0xd8ec6fa2,"lime.utils._Log.LogLevel_Impl_.lte","lime/utils/Log.hx",167,0x300eb2b2)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(167)
	bool tmp = (a <= b);		HX_STACK_VAR(tmp,"tmp");
