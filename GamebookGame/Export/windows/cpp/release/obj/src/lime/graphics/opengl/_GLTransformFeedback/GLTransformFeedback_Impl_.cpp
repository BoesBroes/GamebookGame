...
hx::ObjectPtr< GLTransformFeedback_Impl__obj > GLTransformFeedback_Impl__obj::__new()
{  hx::ObjectPtr< GLTransformFeedback_Impl__obj > _result_ = new GLTransformFeedback_Impl__obj();
...
::lime::graphics::opengl::GLObject GLTransformFeedback_Impl__obj::fromInt( int id){
	HX_STACK_FRAME("lime.graphics.opengl._GLTransformFeedback.GLTransformFeedback_Impl_","fromInt",0xec7828f7,"lime.graphics.opengl._GLTransformFeedback.GLTransformFeedback_Impl_.fromInt","lime/graphics/opengl/GLTransformFeedback.hx",12,0xac3a3468)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(14)
	int tmp = id;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(14)
	::lime::graphics::opengl::GLObject tmp1 = ::lime::graphics::opengl::GLObject_obj::fromInt((int)11,tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(14)
	return tmp1;
}
