...
class HXCPP_CLASS_ATTRIBUTES  Sound_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		bool isBuffering;
		::String url;
		::lime::media::AudioBuffer __buffer;
		virtual Void close( );
		Dynamic close_dyn();
		...
		virtual Void loadCompressedDataFromByteArray( ::openfl::utils::ByteArrayData bytes,int bytesLength);
		...
		virtual Void AudioBuffer_onURLLoad( ::lime::media::AudioBuffer buffer);
