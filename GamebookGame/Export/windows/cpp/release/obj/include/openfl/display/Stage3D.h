...
class HXCPP_CLASS_ATTRIBUTES  Stage3D_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		virtual Void __createContext( ::openfl::display::Stage stage,::openfl::_internal::renderer::RenderSession renderSession);
		Dynamic __createContext_dyn();

		virtual Void __dispatchError( );
		Dynamic __dispatchError_dyn();

		virtual Void __dispatchCreate( );
		Dynamic __dispatchCreate_dyn();

		virtual Void __renderCairo( ::openfl::display::Stage stage,::openfl::_internal::renderer::RenderSession renderSession);
		Dynamic __renderCairo_dyn();

		virtual Void __renderCanvas( ::openfl::display::Stage stage,::openfl::_internal::renderer::RenderSession renderSession);
