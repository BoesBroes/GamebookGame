...
class HXCPP_CLASS_ATTRIBUTES  BitmapData_obj : public hx::Object{
	...
	public:
		...
		int width;
		Dynamic __blendMode;
		::lime::graphics::opengl::GLObject __buffer;
		::lime::_backend::native::NativeGLRenderContext __bufferContext;
		Float __bufferAlpha;
		::lime::utils::ArrayBufferView __bufferData;
		::lime::graphics::opengl::GLObject __framebuffer;
		::lime::_backend::native::NativeGLRenderContext __framebufferContext;
		bool __isValid;
		Dynamic __surface;
		...
		virtual ::lime::graphics::opengl::GLObject getBuffer( ::lime::_backend::native::NativeGLRenderContext gl,Float alpha);
		...
		virtual ::lime::graphics::opengl::GLObject getTexture( ::lime::_backend::native::NativeGLRenderContext gl);
		...
		virtual Void __applyAlpha( ::openfl::utils::ByteArrayData alpha);
		Dynamic __applyAlpha_dyn();

		virtual Void __draw( ::openfl::display::IBitmapDrawable source,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform colorTransform,Dynamic blendMode,::openfl::geom::Rectangle clipRect,hx::Null< bool >  smoothing);
		Dynamic __draw_dyn();

		virtual Void __fromBase64( ::String base64,::String type);
		Dynamic __fromBase64_dyn();

		virtual Void __fromBytes( ::openfl::utils::ByteArrayData bytes,::openfl::utils::ByteArrayData rawAlpha);
		...
		virtual ::lime::graphics::opengl::GLObject __getFramebuffer( ::lime::_backend::native::NativeGLRenderContext gl);
		Dynamic __getFramebuffer_dyn();

		virtual ::lime::app::Future __loadFromBase64( ::String base64,::String type);
		Dynamic __loadFromBase64_dyn();

		virtual ::lime::app::Future __loadFromBytes( ::openfl::utils::ByteArrayData bytes,::openfl::utils::ByteArrayData rawAlpha);
		Dynamic __loadFromBytes_dyn();

		virtual ::lime::app::Future __loadFromFile( ::String path);
		Dynamic __loadFromFile_dyn();
