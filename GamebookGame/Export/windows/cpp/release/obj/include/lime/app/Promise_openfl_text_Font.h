...
class HXCPP_CLASS_ATTRIBUTES  Promise_openfl_text_Font_obj : public hx::Object{
	...
	public:
		...
		bool isComplete;
		bool isError;
		virtual ::lime::app::Promise_openfl_text_Font complete( ::openfl::text::Font data);
		Dynamic complete_dyn();

		virtual ::lime::app::Promise_openfl_text_Font completeWith( ::lime::app::Future future);
		Dynamic completeWith_dyn();

		virtual ::lime::app::Promise_openfl_text_Font error( Dynamic msg);
		Dynamic error_dyn();

		virtual ::lime::app::Promise_openfl_text_Font progress( int progress,int total);
