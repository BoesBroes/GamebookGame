...
class HXCPP_CLASS_ATTRIBUTES  Promise_lime_media_AudioBuffer_obj : public hx::Object{
	...
	public:
		...
		bool isComplete;
		bool isError;
		virtual ::lime::app::Promise_lime_media_AudioBuffer complete( ::lime::media::AudioBuffer data);
		Dynamic complete_dyn();

		virtual ::lime::app::Promise_lime_media_AudioBuffer completeWith( ::lime::app::Future future);
		Dynamic completeWith_dyn();

		virtual ::lime::app::Promise_lime_media_AudioBuffer error( Dynamic msg);
		Dynamic error_dyn();

		virtual ::lime::app::Promise_lime_media_AudioBuffer progress( int progress,int total);
